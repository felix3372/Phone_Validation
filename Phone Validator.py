...
with tab1:
    ...
    # Input section - full width with spacing
    ...
    with col_center:
        validate_button = st.button("🔍 Validate Number", type="primary", use_container_width=True)
    
    st.markdown("")  # Add spacing
    
    # Results section - appears below with clear separator
